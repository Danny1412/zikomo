                    ...
                    <div class="overflow-hidden">
                        <div class="flex justify-between mb-4">
                            <div class="flex-1">
                                ...
                                <div class="flex">
                                    @include('admin.employed.modalcrear')

                                    @include('admin.employed.modalimport')
                                </div>
                        ...
                        <table class="min-w-full">
                            ...
                            @foreach ($employeds as $employed)
                                    ...
                                    <tr class="bg-orange-300 border-b border-gray-400">
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-gray-900 border-gray-400 whitespace-nowrap border-x">
                                                <form action="{{ route('empleados.destroy', $employed->id) }}" method="post">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit"
                                                ...
                                                <a href="{{ route('empleados.edit', $employed) }}"
