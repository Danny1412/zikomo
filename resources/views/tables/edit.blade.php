...
<div class="p-6 bg-orange-300 rounded-lg shadow-lg shadow-orange-400">
        <h2 class="mb-4 text-2xl font-bold">Editar Mesas</h2>
        <form action="{{ route('tables.update', $table->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="nombre" name="nombre" type="text" value="{{ $table->nombre }}" required>
            </div>
            <div class="mb-4">
                <label class="block mb-2 font-bold text-gray-700" for="descripcion">Estado</label>
                <select name="estado"
                    ...
                    <option value="{{ 0 }}" {{ $table->estado == 0 ? 'selected' : '' }}>Disponible</option>
                </select>
